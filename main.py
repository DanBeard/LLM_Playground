...
llm = LlamaCpp(
    ...
    #model_path="./ggml-vicuna-13B-1.1-q8_0.bin",
    #model_path="./WizardLM-7B-uncensored.ggmlv3.q5_1.bin",
    #model_path="./WizardLM-7B-uncensored.ggmlv3.q8_0.bin",
    model_path="./stable-vicuna-13B.ggmlv3.q6_K.bin",
...
agent_chain = initialize_agent(tools, llm, agent=AgentType.CONVERSATIONAL_REACT_DESCRIPTION, memory=memory, verbose=True, callback_manager=None)
